...
public:
	...
	static uint64_t const publish_full_threshold = 0xfffffe0000000000; // NANO: 0xffffffc000000000
	static uint64_t const publish_threshold = rai::rai_network == rai::rai_networks::bolt_test_network ? publish_test_threshold : publish_full_threshold;
};
}
