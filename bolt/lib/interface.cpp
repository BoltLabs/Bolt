...
#include <bolt/lib/blocks.hpp>
#include <bolt/lib/numbers.hpp>
#include <bolt/lib/work.hpp>

#include <cstring>

extern "C" {
void blt_uint128_to_dec (blt_uint128 source, char * destination)
{
...
void blt_uint512_to_string (blt_uint512 source, char * destination)
{
...
int blt_valid_address (const char * account_a)
{
...
void blt_key_account (const blt_uint256 key, blt_uint256 pub)
{
