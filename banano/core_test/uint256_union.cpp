...
TEST (uint128_union, balance_format)
{
	...
	ASSERT_EQ ("12-3456-789+123", rai::amount (rai::BAN_ratio * 123456789 + rai::mBAN_ratio * 123).format_balance (rai::BAN_ratio, 4, true, std::locale (std::cout.getloc (), new test_punct)));
}
